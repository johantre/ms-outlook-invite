...
## Distribution Automation artifacts
...
When importing such Solution, the import allows you to select *your* connector, using your credentials. 
...
Your connection stays the same, no worries here. 
...
However, users that aren't operating under a Premium license (like Office 365 Standard) should also be able to enjoy the automation built in this repo. 
...
They use the **Latest \<brand name\> Solution Build** naming convention. E.g. "Latest volvo Solution Build" \
...
They use the **Latest \<brand name\> Solution Build (user name)** naming convention. E.g. "Latest volvo Solution Build (test.user)" 
